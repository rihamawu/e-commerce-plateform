<template>
  <div class="wrapper">
    <nav class="navbar" role="navigation" aria-label="main navigation">
      <div class="navbar-brand">
        <a class="navbar-item" href="/">
          <span style="font-family: 'Serif', sans-serif; font-size: 24px; font-weight: bold; color: #000;">
            AuraDeLux
          </span>
        </a>
    ...
    <!-- footer -->
    <footer class="footer">
      <p class="has-text-centered">Copyright Riham Baquroun (c) 2024</p>
    </footer>
